...
export class AccountService {
     ...
     */
    public apiAccountCheckUsernameUsernameGet(username: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiAccountCheckUsernameUsernameGet(username: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiAccountCheckUsernameUsernameGet(username: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiAccountCheckUsernameUsernameGet(username: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (username === null || username === undefined) {
            throw new Error('Required parameter username was null or undefined when calling apiAccountCheckUsernameUsernameGet.');
        }
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/api/account/check-username/${encodeURIComponent(String(username))}`,
            {
